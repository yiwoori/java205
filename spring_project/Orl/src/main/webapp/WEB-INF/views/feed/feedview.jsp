...
<body>
    ...
    <section class="container">
        ...
        <section class="leftbox">
            ...
            <button><img src="/FEED/images/icon-05.png"></button>
        </section>
        ...
        <section class="rightbox">
                ...
                <div>
                    <div class="comments">
                        <div class="cmt-profile">
                            <button><img src="/FEED/images/cmt-profile.jpg" alt="cmt-profile-img"></button>
                        </div>
                        <div class="comment">
            ...
            <section class="commentingbox">
                <div class="buttonline">
                    <div>
                        <button class="like">
                            <img src="/FEED/images/like-black.png" class="nolike" alt="like-img">
                            <!-- <img src="/images/like.png" class="like-red" alt="nolike-img"> -->
                        </button>
                        <button class="write"><img src="/FEED/images/comment.png" alt="comment-img"></button>
                        <button class="share"><img src="/FEED/images/share.png" alt="share-img"></button>
                    </div>
                    <div class="likeline">
                        <p>좋아요 1,000개</p>
                    </div>
