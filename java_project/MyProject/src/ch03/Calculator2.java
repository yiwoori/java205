...
//		System.out.println(cal.circleArea(3.2f));
		...
		System.out.println();
		System.out.printf("덧셈 결과(%d+%d) : "+cal.add(value1, value2),value1,value2);
		System.out.println();
		System.out.printf("뺄셈 결과(%d-%d) : "+cal.sub(value1, value2),value1,value2);
		System.out.println();
		System.out.printf("곱셈 결과(%d*%d) : "+cal.mult(value1, value2),value1,value2);
		System.out.println();
		System.out.printf("나눗셈 결과(%d/%d) : "+cal.div(value1, value2),value1,value2);
		System.out.println();
		System.out.println("===========================================");		
		System.out.print("원의 둘레를 구할 반지름 값을 입력해주세요 : ");
		float r1 = scn.nextFloat();
		System.out.println("원의 둘레 : "+cal.circlePeri(r1));
		System.out.println("===========================================");
		System.out.print("원의 넓이를 구할 반지름 값을 입력해주세요 : ");
